...
This external REST function executes an OTBI report using the Oracle BI SOAP Web Service `executeXMLQuery` operation. Requires a valid Session ID from the authentication service.
